...
![선형 큐 문제](./attachments/linear_q.jpg)
_선형 큐의 문제점_
...
![원형 큐 1](./attachments/circular_q.jpg)
_원형 큐로의 변환_
...
![원형 큐 2](./attachments/circular_q2.jpg)
_원형 큐의 또다른 모습_
...
> [!info] 여기서는 큐의 (맨 앞 요소 - 1)을 `front` 인덱스로 사용합니다. 아래에 설명.
