---
title: 10. 리스트 응용 - 스택과 큐
description: 연결리스트를 활용하여 스택과 큐를 구현해보아요.
pubDate: 2023-08-22 14:19 +0900
categories:
...
## 📚 스택의 구현
![stack](../../attachments/data-structure/2023-08-22-stack-and-queue-made-with-linked-list/stack1.png){: w="1237"}
_스택을 연결리스트로 바꾼 모습_
...
## ⏰ 큐의 구현
![queue](../../attachments/data-structure/2023-08-22-stack-and-queue-made-with-linked-list/q1.png){: w="1320"}
_큐를 연결리스트로 바꾼 모습_
큐의 구현도 그렇게 어렵지는 않다. 다만 큐의 앞과 뒤를 가르키는 `front, rear` 포인터를 잘 활용해야 한다.

![queue](../../attachments/data-structure/2023-08-22-stack-and-queue-made-with-linked-list/q2.png){: w="1119"}
_큐에 삽입하는 과정_
...
![output](../../attachments/data-structure/2023-08-22-stack-and-queue-made-with-linked-list/output.png){: w="1280"}
_출력 결과_
