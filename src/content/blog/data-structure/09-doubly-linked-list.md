---
title: 09. 이중 연결 리스트
description: 이중으로 연결된 리스트를 구현해보아요.
pubDate: 2023-08-15 23:30 +0900
categories:
...
![dlist1](../../attachments/data-structure/2023-08-15-doubly-linked-list/dlist1.png){: w="1061}
_이중 연결리스트의 모습_
...
### 삽입과 제거
![insert1](../../attachments/data-structure/2023-08-15-doubly-linked-list/dlist-insert.gif){: h="360"}
_일반적인 삽입 연산_
...
![remove1](../../attachments/data-structure/2023-08-15-doubly-linked-list/dlist-remove.gif){: h="360"}
_일반적인 제거 연산_
...
### 맨 앞에 삽입
![insert2](../../attachments/data-structure/2023-08-15-doubly-linked-list/dlist-insert2.gif){: w="750"}
_맨 앞에 삽입하기_
...
![output](../../attachments/data-structure/2023-08-15-doubly-linked-list/output.png){: h="660"}
_출력 결과_
