...
![dlist1](./attachments/dlist1.png)
_이중 연결리스트의 모습_

이중 연결리스트는 말 그대로 노드 간의 연결이 이중으로 되어있는 리스트 자료구조이다. 노드에는 다음 노드의 정보뿐만 아니라 이전 노드를 가르키고 있는 포인터도 가지고있다. 여기서는 이중 연결리스트와 원형 연결리스트를 합친 버젼에 대해 공부한다.
...
![insert1](./attachments/dlist-insert.gif)
_일반적인 삽입 연산_
...
![remove1](./attachments/dlist-remove.gif)
_일반적인 제거 연산_
...
![insert2](./attachments/dlist-insert2.gif)
_맨 앞에 삽입하기_
...
[pastebin 보러가기](https://pastebin.com/fMEm56b6)


추가적으로 맨 뒤에 삽입, 제거하는 함수를 구현해놓았다.

![output 3](./attachments/output%203.png)
_출력 결과_
