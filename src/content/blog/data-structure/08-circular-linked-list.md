...
![circular-list](../../attachments/data-structure/2023-08-08-circular-linked-list/clist1.png){: w="949"}
_원형 연결리스트_
...
## 💡 원형 연결리스트의 구현
> 여기서는 리스트의 맨 앞, 뒤에 삽입, 제거하는 동작만 설명한다.  
...
### 리스트 맨 앞에 삽입하기
![insert](../../attachments/data-structure/2023-08-08-circular-linked-list/insert.gif){: h="360"}
_맨 앞에 삽입_
...
### 리스트의 맨 앞 요소 제거하기
![remove1](../../attachments/data-structure/2023-08-08-circular-linked-list/remove1.gif){: h="360"}
_맨 앞 요소 제거하기_
...
> 반면에 맨 뒤의 요소를 제거하는 과정은 *선형 탐색*이 필요하다. 맨 뒤 노드의 이전 노드(헤드 노드의 이전 노드)를 리스트의 맨 앞 노드 (헤드 노드의 다음 노드)에 연결해야하는데 현재 원형 연결리스트로는 결국에는 한바퀴 돌아야 맨 뒤로 돌아오기 때문이다.
{: .prompt-tip}

## 💻 코드 전체

[pastebin 보러가기](https://pastebin.com/wAwKJDwK){: target="_blank"}

![output](../../attachments/data-structure/2023-08-08-circular-linked-list/output.png){: w="1280"}
_출력 결과_
