---
title: 11. 트리
description: 트리 자료구조에 대해 알아보아요.
pubDate: 2023-09-03 15:47 +0900
math: true
categories:
...
## 🔍 트리(Tree) 자료구조란?
![트리](../../attachments/data-structure/2023-09-03-basics-of-tree/tree.png){: h="1000"}
...
![tree-terms](../../attachments/data-structure/2023-09-03-basics-of-tree/tree-terms.png){: h="1000"}
_그림으로 보는 트리 용어_
- 트리는 *노드*들로 이루어진다.
...
![node count](../../attachments/data-structure/2023-09-03-basics-of-tree/node-count.png){: h="1000"}

- 높이 $h$의 이진트리의 노드 개수 $n$은, $h \leq n \leq 2^{h}-1$이다.

![height](../../attachments/data-structure/2023-09-03-basics-of-tree/height.png){: h="1000"}

- $n$개의 노드를 가지는 이진트리의 높이 $h$는, $\left\lceil \, \log_{2}{(n+1)} \, \right\rceil \leq h \leq n$이다.

![full tree](../../attachments/data-structure/2023-09-03-basics-of-tree/full-b-tree.png){: h="1000"}
...
![how to tree](../../attachments/data-structure/2023-09-03-basics-of-tree/tree-how.png){: h="1000"}
_배열 표현법 vs 포인터 표현법_
