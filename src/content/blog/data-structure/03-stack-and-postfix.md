...
![Infix vs Postfix](./attachments/postfix01.png)
...
![후위표기식 계산](./attachments/postfix02.png)
_후위표기식 계산법_
...
> [!tip] 참고 : [영문 위키피디아 - 후위표기식 변환 알고리즘](https://en.wikipedia.org/wiki/Shunting_yard_algorithm)
...
> [!info] 이전에 작성한 동적 스택을 변형하여 사용합니다. [pastebin 보러가기](https://pastebin.com/uBXus6as)
